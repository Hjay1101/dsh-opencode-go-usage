...
- The modal is a **swipeable carousel**: the default card shows Go usage (three windows + dollar conversion), while the next card shows every supported OpenCode Go model and its monthly cap
